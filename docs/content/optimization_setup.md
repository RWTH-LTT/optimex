...
Once your Brightway databases are configured, you need to set up the optimization problem: define the demand, configure characterization, process the LCA data, and create the optimization model.
